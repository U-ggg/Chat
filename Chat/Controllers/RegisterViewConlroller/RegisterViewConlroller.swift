...
class RegisterViewConlroller: UIViewController {
    ...
    private func setupViews() {
        view.backgroundColor = UIColor(named: Const.Colors.brandLightBlue)
...
extension RegisterViewConlroller: UITextFieldDelegate {
